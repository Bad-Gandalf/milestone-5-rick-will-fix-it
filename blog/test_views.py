...
class TestBlogViews(TestCase):
    ...
    def test_blog_list_retrieval_with_blog(self):
        user = User(username="username", email="email@gmail.com", password="password")
        user.save()
        blog = Blog(author=user, title="Test Title", content="Test Content")
        blog.save()
    ...
    def test_blog_list_retrieval_without_blog(self):
        page = self.client.get("/")
        self.assertEqual(page.status_code, 200)
        self.assertTemplateUsed(page, "blog/index.html")
    ...
    def test_admin_panel_render_change_form(self):
        ...
        data = {"title": "test Title", "author":user, "content":'test content'}
